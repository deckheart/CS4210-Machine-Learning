...
Original file is located at
    https://colab.research.google.com/drive/1JYBSRMFmrt0t5c_Zpkd8uFpGa7AG5B_p
"""
...
# TIME SPENT: 3 hours for association_rule_mining.py
#-----------------------------------------------------------*/
...
for index, row in df.iterrows():
  ...
  for item in itemset:
    labels[str(item)] = (item in row.values)
