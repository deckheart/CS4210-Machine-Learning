...
Original file is located at
    https://colab.research.google.com/drive/1bVszOBIMPcngQDmTzcwYuURI-y5xrMZE
"""

#-------------------------------------------------------------------------
# AUTHOR: Dakota Eckheart
# FILENAME: clustering.py
# SPECIFICATION: Find the optimal number of clusters for K-means and agglomerative clustering
# FOR: CS 4210- Assignment #5
# TIME SPENT: 1.5 hours for clustering.py
#-----------------------------------------------------------*/
...
for k in range(2, 21):
  ...
  silhouette_scores.append(temp_sil)
  if temp_sil > max_silhouette:
    max_silhouette = temp_sil
    max_k = k 

#plot the value of the silhouette_coefficient for each k value of kmeans so that we can see the best k
plt.plot([x for x in range(2, 21)], silhouette_scores)
print("Max k, silhouette: ", max_k, ",", max_silhouette)

#reading the validation data (clusters) by using Pandas library
X_testing = pd.read_csv('testing_data.csv', header=None) #reading the data by using Pandas library
